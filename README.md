...
# Instalation
[Download](https://github.com/pinatacolada/topskylppc/archive/v0.2.zip) and unzip the contents of topskylppc-0.2 folder into the folder where you keep your LPPC sector file. It should ask you to overwrite some files, say yes to those.
