...
# Instalation
[Download](https://github.com/pinatacolada/topskylppc/archive/1.1.1.zip) and unzip the contents of topskylppc-1.1 folder into the folder where you keep your LPPC sector file. It should ask you to overwrite some files, say yes to those.
