...
1.   Download and install TrackAudio from https://github.com/pierr3/TrackAudio/releases.

1.   Open TrackAudio and click on the settings cog.

     ![Autoload](/assets/img/ta1.png)

1.   Open TrackAudio. Fill out the CID and password fields with your VATSIM credentials, select your appropriate hardware devices, and at least a PTT 1 key. The remaining settings may be set according to your preference, but it is recomended to be set as per below.

     ![Autoload](/assets/img/ta2.png)

1.   Download and install VACS from https://vacs.network/.

1.   Open VACS. Open the settings menu, then Transmit.
...
1.   Download the sector file from https://files.aero-nav.com/LPPC. Extract the contents of the zip file into
'%appdata%\EuroScope\'.
