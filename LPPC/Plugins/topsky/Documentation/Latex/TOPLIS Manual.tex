...
\label{win:hop}
A Handover Proposal can be used to propose non-standard transfer parameters (AHDG/Direct-to and ASP) to the next sector. For the receiving controller a HOP is identified by coloring the callsign data field with “Proposition” color in the label. For the sending controller the Callsign field remains “Assumed” color and the Sector Indicator field is shown in “Proposition” color. Additionally, if there are proposed parameters they are also colored “Proposition” in both controllers’ labels.
...
Global Menu -> Tools -> Flight Plan Lists -> Sector List…
...
Global Menu -> Tools -> Flight Plan Lists -> Load Factor List…
...
Global Menu -> Tools -> Flight Plan Lists -> Main VFR List… / Uncontrolled List 1…
...
Global Menu -> Tools -> Flight Plan Lists -> Secondary VFR List… / Uncontrolled List 2…
...
Global Menu -> Tools -> Flight Plan Lists -> ETWR List...
...
Global Menu -> Tools -> Flight Plan Lists -> Resectorisation List…
...
Global Menu -> Tools -> Flight Plan Lists -> Traffic Management List 1…
...
Global Menu -> Tools -> Flight Plan Lists -> Traffic Management List 2…
...
Global Menu -> Tools -> Flight Plan Lists -> Lost List…
...
Global Menu -> Tools -> Vertical Aid Window...
...
Global Menu -> Tools -> CPDLC -> Microphone Check
...
Global Menu -> Tools -> CPDLC -> Current Messages...
...
Global Menu -> Tools -> CPDLC -> History Messages...
...
Global Menu -> MSG -> Personal Queue...
...
Global Menu -> MSG -> ATC Messages...
Global Menu -> MSG -> Prim Freq Messages...
...
Global Menu -> MSG -> NAT Track Messages...
...
Global Menu -> STS -> Safety Nets Status...
...
Global Menu -> STS -> Divergence Detection Status...
...
Global Menu -> STS -> Supervisory -> Predicted Traffic...
...
Global Menu -> STS -> RWY line display... (opens the \textit{\titleref{menu:ad}} for airport selection)
