...
\begin{tabular}{l l l}
  ...
  Unconcerned           & \cellcolor{Flight Highlight}\color{Unconcerned}Unconcerned     & Track will not enter the active sector\\
  ...
  On Contact            & \colorref{color:Assumed}         & Track is on-contact with you\\
...
Coordinated tracks that have not departed yet are shown as Notified.

\subsection{Aircraft position symbol}

The position symbol is drawn at the latest known position of the aircraft. The color of the symbol is the flight sector color for an unselected track and \colorref{color:Track Highlight} for a selected one. A number of different symbols are available. 
...
\image{img/rps_sec.png} & Secondary or combined radar track (uncontrolled)\\
\image{img/rps_psr+ssr.png} & Secondary or combined radar track (controlled)\\
 & ADS-B only track\\
\end{tabular}
...
\textit{\titleref{menu:global}} Tools -> Flight Plan Lists -> Main VFR List… / Uncontrolled List 1…
...
\textit{\titleref{menu:global}} Tools -> Flight Plan Lists -> Secondary VFR List… / Uncontrolled List 2…
...
\textit{\titleref{menu:global}} Tools -> Flight Plan Lists -> Traffic Management List 1…
...
\textit{\titleref{menu:global}} Tools -> Flight Plan Lists -> Traffic Management List 2…
