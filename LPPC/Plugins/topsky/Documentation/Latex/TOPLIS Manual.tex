...
\begin{longtable}{|p{4.5cm}|p{1.5cm}|p{4.5cm}|}
  ...
  Proposition Accepted                       & \cellcolor[RGB]{255,255,0} & Labels                                       \\ \hline
  ...
  Active Map Type 3                          & \cellcolor[RGB]{179,180,180} & TSA map border/fill                          \\ \hline
  ...
  Active Map Type 6                          & \cellcolor[RGB]{114,69,58} & TSA map border/fill                          \\ \hline
  ...
  Text Notes                                 & \cellcolor[RGB]{255,0,0} & Text notes \\ \hline                                 
  \end{longtable}
