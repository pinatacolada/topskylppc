...
The plugin supports Departure Clearance (DCL) and Controller-Pilot Data Link Communications (CPDLC).
...
The plugin may sometimes fail to parse the message contents correctly. The longer the message, the more likely it is that the parsing will go wrong. When in doubt, open the message in the \textit{\titleref{win:dlcmw}}.
...
If the request is correctly formatted, the plugin will automatically send a flight system message (FSM) as a reply. Its content depends on whether all the requirements for a DCL are met (flight plan found, departure airport offers data link clearances, etc.). If so, the following reply message is sent to the aircraft:
...
The “+” after the level indicates that there is a reason in the answer message (for example “DUE TO PERFORMANCE”). Read the message in the \textit{\titleref{win:dlcmw}} to find out what it is.
...
As with DCL messages, the most likely failure scenario is the plugin misinterpreting the contents of a received message, so keep an eye on the \textit{\titleref{win:dlcmw}}. Some other failure scenarios are presented below.
...
\begin{longtable}{|p{4.5cm}|p{1.5cm}|p{4.5cm}|}
  ...
  \nextrow \label{color:C_Assumed} Assumed                               & \cellcolor{C_Assumed}                 & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_CARD_Mark_All} CARD Mark All                   & \cellcolor{C_CARD_Mark_All}           & Labels                                       \\ \hline
  \nextrow \label{color:C_CARD_Mark_Own} CARD Mark Own                   & \cellcolor{C_CARD_Mark_Own}           & Labels                                       \\ \hline
  \nextrow \label{color:C_Concerned} Concerned                           & \cellcolor{C_Concerned}               & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Coordination} Coordination                     & \cellcolor{C_Coordination}            & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Freq_Indicator} Freq Indicator                 & \cellcolor{C_Freq_Indicator}          & Labels                                       \\ \hline
  \nextrow \label{color:C_Info_Coord} Info Coord                         & \cellcolor{C_Info_Coord}              & Labels                                       \\ \hline
  \nextrow \label{color:C_Information} Information                       & \cellcolor{C_Information}             & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_Informed_1} Informed 1                         & \cellcolor{C_Informed_1}              & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Informed_2} Informed 2                         & \cellcolor{C_Informed_2}              & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Informed_3} Informed 3                         & \cellcolor{C_Informed_3}              & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Proposition_Accepted} Proposition Accepted     & \cellcolor{C_Proposition_Accepted}    & Labels                                       \\ \hline
  \nextrow \label{color:C_Proposition_In} Proposition In                 & \cellcolor{C_Proposition_In}          & Labels                                       \\ \hline 
  \nextrow \label{color:C_Proposition_Out} Proposition Out               & \cellcolor{C_Proposition_Out}         & Labels                                       \\ \hline
  \nextrow \label{color:C_Redundant} Redundant                           & \cellcolor{C_Redundant}               & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Rwy_Locked} Rwy Locked                         & \cellcolor{C_Rwy_Locked}              & Labels                                       \\ \hline
  \nextrow \label{color:C_Sid_Star_Allocation} Sid Star Allocation       & \cellcolor{C_Sid_Star_Allocation}     & Labels                                       \\ \hline
  \nextrow \label{color:C_Sid_Star_No_Allocation} Sid Star No Allocation & \cellcolor{C_Sid_Star_No_Allocation}  & Labels                                       \\ \hline
  \nextrow \label{color:C_Suite_Highlight} Suite Highlight               & \cellcolor{C_Suite_Highlight}         & Labels                                       \\ \hline
  \nextrow \label{color:C_Track_Default} Track Default                   & \cellcolor{C_Track_Default}           & Tracks                                       \\ \hline
  \nextrow \label{color:C_Track_Highlight} Track Highlight               & \cellcolor{C_Track_Highlight}         & Tracks (when selected)                       \\ \hline
  \nextrow \label{color:C_Unconcerned} Unconcerned                       & \cellcolor{C_Unconcerned}             & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Unknown} Unknown                               & \cellcolor{C_Unknown}                 & Labels                                       \\ \hline
  \nextrow \label{color:C_Urgency} Urgency                               & \cellcolor{C_Urgency}                 & Labels, STCA callsign background on plugin windows/lists \\ \hline
  \nextrow \label{color:C_VFR} VFR                                       & \cellcolor{C_VFR}                     & Labels, Tracks                               \\ \hline
  \nextrow \label{color:C_Warning} Warning                               & \cellcolor{C_Warning}                 & Labels, APW callsign background on plugin windows/lists, Windows \\ \hline
  \nextrow \textit{\textbf{CPDLC colors}}                                &                                       &                                              \\ \hline
  \nextrow \label{color:C_CPDLC_Controller_Late} CPDLC Controller Late   & \cellcolor{C_CPDLC_Controller_Late}   & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Discarded} CPDLC Discarded               & \cellcolor{C_CPDLC_Discarded}         & Windows                                      \\ \hline
  \nextrow \label{color:C_CPDLC_DM_Request} CPDLC DM Request             & \cellcolor{C_CPDLC_DM_Request}        & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Failed} CPDLC Failed                     & \cellcolor{C_CPDLC_Failed}            & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Pilot_Late} CPDLC Pilot Late             & \cellcolor{C_CPDLC_Pilot_Late}        & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Standby} CPDLC Standby                   & \cellcolor{C_CPDLC_Standby}           & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_UM_Clearance} CPDLC UM Clearance         & \cellcolor{C_CPDLC_UM_Clearance}      & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Unable} CPDLC Unable                     & \cellcolor{C_CPDLC_Unable}            & Labels, Windows                              \\ \hline
  \nextrow \label{color:C_CPDLC_Urgency} CPDLC Urgency                   & \cellcolor{C_CPDLC_Urgency}           & Labels, Windows                              \\ \hline
  \nextrow \textit{\textbf{Aircraft related items on the radar screen}}  &                                       &                                              \\ \hline
  \nextrow \label{color:C_AIW_intrusion} AIW intrusion                   & \cellcolor{C_AIW_intrusion}           & AIW alert related items                      \\ \hline
  \nextrow \label{color:C_CARD_Min_Sep} CARD Min Sep                     & \cellcolor{C_CARD_Min_Sep}            & CARD SEP Tool                                \\ \hline
  \nextrow \label{color:C_Flight_Leg} Flight Leg                         & \cellcolor{C_Flight_Leg}              & Part of flight leg without MTCD and SAP coverage \\ \hline
  \nextrow \label{color:C_FPLSEP_Tool_1} FPLSEP Tool 1                   & \cellcolor{C_FPLSEP_Tool_1}           & Flight plan separation tool 1                \\ \hline
  \nextrow \label{color:C_FPLSEP_Tool_2} FPLSEP Tool 2                   & \cellcolor{C_FPLSEP_Tool_2}           & Flight plan separation tool 2                \\ \hline
  \nextrow \label{color:C_FPLSEP_Tool_3} FPLSEP Tool 3                   & \cellcolor{C_FPLSEP_Tool_3}           & Flight plan separation tool 3                \\ \hline
  \nextrow \label{color:C_FPLSEP_Tool_4} FPLSEP Tool 4                   & \cellcolor{C_FPLSEP_Tool_4}           & Flight plan separation tool 4                \\ \hline
  \nextrow \label{color:C_FPLSEP_Tool_5} FPLSEP Tool 5                   & \cellcolor{C_FPLSEP_Tool_5}           & Flight plan separation tool 5                \\ \hline
  \nextrow \label{color:C_Heading_Vector} Heading Vector                 & \cellcolor{C_Heading_Vector}          & Heading vector                               \\ \hline
  \nextrow \label{color:C_Information_FL} Information FL                 & \cellcolor{C_Information_FL}          & Part of flight leg with no MTCD or SAP problems \\ \hline
  \nextrow \label{color:C_Potential_FL} Potential FL                     & \cellcolor{C_Potential_FL}            & Part of flight leg with MTCD or SAP potential conflict \\ \hline
  \nextrow \label{color:C_QDM} QDM                                       & \cellcolor{C_QDM}                     & QDM vector                                   \\ \hline
  \nextrow \label{color:C_SEP_Tool_1} SEP Tool 1                         & \cellcolor{C_SEP_Tool_1}              & Minimum separation tool 1                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_2} SEP Tool 2                         & \cellcolor{C_SEP_Tool_2}              & Minimum separation tool 2                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_3} SEP Tool 3                         & \cellcolor{C_SEP_Tool_3}              & Minimum separation tool 3                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_4} SEP Tool 4                         & \cellcolor{C_SEP_Tool_4}              & Minimum separation tool 4                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_5} SEP Tool 5                         & \cellcolor{C_SEP_Tool_5}              & Minimum separation tool 5                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_6} SEP Tool 6                         & \cellcolor{C_SEP_Tool_6}              & Minimum separation tool 6                    \\ \hline
  \nextrow \label{color:C_SEP_Tool_7} SEP Tool 7                         & \cellcolor{C_SEP_Tool_7}              & Minimum separation tool 7                    \\ \hline
  \nextrow \label{color:C_SEP_Vert} SEP Vert                             & \cellcolor{C_SEP_Vert}                & Extensions of minimum separation tools       \\ \hline
  \nextrow \label{color:C_System_Calculated_TOC} System Calculated TOC   & \cellcolor{C_System_Calculated_TOC}   & TOC symbol on flight leg                     \\ \hline
  \nextrow \label{color:C_System_Calculated_TOD} System Calculated TOD   & \cellcolor{C_System_Calculated_TOD}   & TOD symbol on flight leg                     \\ \hline
  \nextrow \label{color:C_Urgency_FL} Urgency FL                         & \cellcolor{C_Urgency_FL}              & Part of flight leg with MTCD or SAP conflict \\ \hline
  \nextrow \label{color:C_Warning_FL} Warning FL                         & \cellcolor{C_Warning_FL}              & Part of flight leg with MTCD or SAP risk     \\ \hline
  \nextrow \textit{\textbf{Map colors}}                                  &                                       &                                              \\ \hline
  \nextrow \label{color:C_Active_Map} Active Map                         & \cellcolor{C_Active_Map}              & Active TSA map border                        \\ \hline
  \nextrow \label{color:C_Active_Map_Type_1} Active Map Type 1           & \cellcolor{C_Active_Map_Type_1}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_2} Active Map Type 2           & \cellcolor{C_Active_Map_Type_2}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_3} Active Map Type 3           & \cellcolor{C_Active_Map_Type_3}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_4} Active Map Type 4           & \cellcolor{C_Active_Map_Type_4}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_5} Active Map Type 5           & \cellcolor{C_Active_Map_Type_5}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_6} Active Map Type 6           & \cellcolor{C_Active_Map_Type_6}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_7} Active Map Type 7           & \cellcolor{C_Active_Map_Type_7}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_8} Active Map Type 8           & \cellcolor{C_Active_Map_Type_8}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_9} Active Map Type 9           & \cellcolor{C_Active_Map_Type_9}       & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_10} Active Map Type 10         & \cellcolor{C_Active_Map_Type_10}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_11} Active Map Type 11         & \cellcolor{C_Active_Map_Type_11}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_12} Active Map Type 12         & \cellcolor{C_Active_Map_Type_12}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_13} Active Map Type 13         & \cellcolor{C_Active_Map_Type_13}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_14} Active Map Type 14         & \cellcolor{C_Active_Map_Type_14}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_15} Active Map Type 15         & \cellcolor{C_Active_Map_Type_15}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_16} Active Map Type 16         & \cellcolor{C_Active_Map_Type_16}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_17} Active Map Type 17         & \cellcolor{C_Active_Map_Type_17}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_18} Active Map Type 18         & \cellcolor{C_Active_Map_Type_18}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_19} Active Map Type 19         & \cellcolor{C_Active_Map_Type_19}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_Map_Type_20} Active Map Type 20         & \cellcolor{C_Active_Map_Type_20}      & TSA map border/fill                          \\ \hline
  \nextrow \label{color:C_Active_RD_Infill_Map} Active RD Infill Map     & \cellcolor{C_Active_RD_Infill_Map}    & Active R or D map fill                       \\ \hline
  \nextrow \label{color:C_Active_RD_Map} Active RD Map                   & \cellcolor{C_Active_RD_Map}           & Active R or D map border                     \\ \hline
  \nextrow \label{color:C_Active_Text_Map} Active Text Map               & \cellcolor{C_Active_Text_Map}         & Active TSA map text                          \\ \hline
  \nextrow \label{color:C_Auto_Map_Label} Auto Map Label                 & \cellcolor{C_Auto_Map_Label}          & Auto-generated maps                          \\ \hline
  \nextrow \label{color:C_Auto_Map_Symbol} Auto Map Symbol               & \cellcolor{C_Auto_Map_Symbol}         & Auto-generated maps                          \\ \hline
  \nextrow \label{color:C_East_NAT_Map} East NAT Map                     & \cellcolor{C_East_NAT_Map}            & Auto-generated maps, maps                    \\ \hline
  \nextrow \label{color:C_Map_1} Map 1                                   & \cellcolor{C_Map_1}                   & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_2} Map 2                                   & \cellcolor{C_Map_2}                   & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_3} Map 3                                   & \cellcolor{C_Map_3}                   & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_4} Map 4                                   & \cellcolor{C_Map_4}                   & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_Hotspot} Map Hotspot                       & \cellcolor{C_Map_Hotspot}             & Map hotspots                                 \\ \hline
  \nextrow \label{color:C_Map_Border} Map Border                         & \cellcolor{C_Map_Border}              & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_Info} Map Info                             & \cellcolor{C_Map_Info}                & Range rings, range marker                    \\ \hline
  \nextrow \label{color:C_Map_Land} Map Land                             & \cellcolor{C_Map_Land}                & Maps                                         \\ \hline
  \nextrow \label{color:C_Map_Symbol} Map Symbol                         & \cellcolor{C_Map_Symbol}              & Maps                                         \\ \hline
  \nextrow \label{color:C_Preactive_Map} Preactive Map                   & \cellcolor{C_Preactive_Map}           & Pre-active map border                        \\ \hline
  \nextrow \label{color:C_Preactive_Text_Map} Preactive Text Map         & \cellcolor{C_Preactive_Text_Map}      & Pre-active map text                          \\ \hline
  \nextrow \label{color:C_Predisplay_Map} Predisplay Map                 & \cellcolor{C_Predisplay_Map}          & Pre-display map border                       \\ \hline
  \nextrow \label{color:C_Rwy_App_Line_Inuse} Rwy App Line Inuse         & \cellcolor{C_Rwy_App_Line_Inuse}      & Runway approach line for runways in use      \\ \hline
  \nextrow \label{color:C_Rwy_App_Line_Not_Inuse} Rwy App Line Not Inuse & \cellcolor{C_Rwy_App_Line_Not_Inuse}  & Runway approach line for runways not in use  \\ \hline
  \nextrow \label{color:C_TSA_Border_Highlight} TSA Border Highlight     & \cellcolor{C_TSA_Border_Highlight}    & Highlighted TSA map border                   \\ \hline
  \nextrow \label{color:C_Weather_Map} Weather Map                       & \cellcolor{C_Weather_Map}             & Weather radar data                           \\ \hline
  \nextrow \label{color:C_West_NAT_Map} West NAT Map                     & \cellcolor{C_West_NAT_Map}            & Auto-generated maps, maps                    \\ \hline
  \nextrow \textit{\textbf{Window and menu colors}}                      &                                       &                                              \\ \hline
  \nextrow \label{color:C_Arm} Arm                                       & \cellcolor{C_Arm}                     & Inactive window texts                        \\ \hline
  \nextrow \label{color:C_Map_Bright} Map Bright                         & \cellcolor{C_Map_Bright}              & Stack Manager Window, VAW                    \\ \hline
  \nextrow \label{color:C_Background} Background                         & \cellcolor{C_Background}              & Background                                   \\ \hline
  \nextrow \label{color:C_Border} Border                                 & \cellcolor{C_Border}                  & Various lines in windows                     \\ \hline
  \nextrow \label{color:C_BottomShadow} BottomShadow                     & \cellcolor{C_BottomShadow}            & 3D effects in windows                        \\ \hline
  \nextrow \label{color:C_CARD_Conflict_Number} CARD Conflict Number     & \cellcolor{C_CARD_Conflict_Number}    & CARD conflict numbers                        \\ \hline
  \nextrow \label{color:C_CARD_Time_Vector} CARD Time Vector             & \cellcolor{C_CARD_Time_Vector}        & CARD time vectors                            \\ \hline
  \nextrow \label{color:C_Field_Highlight} Field Highlight               & \cellcolor{C_Field_Highlight}         & Selected field                               \\ \hline
  \nextrow \label{color:C_Flight_Highlight} Flight Highlight             & \cellcolor{C_Flight_Highlight}        & Selected item                                \\ \hline
  \nextrow \label{color:C_Foreground} Foreground                         & \cellcolor{C_Foreground}              & Window titles, menu items, active texts, close/min/resize boxes \\ \hline
  \nextrow \label{color:C_Global_Menu_Highlight} Global Menu Highlight   & \cellcolor{C_Global_Menu_Highlight}   & Highlighted items in the Global Menu         \\ \hline
  \nextrow \label{color:C_Inactive_Sector} Inactive Sector               & \cellcolor{C_Inactive_Sector}         & CARD and VAW background                      \\ \hline
  \nextrow \label{color:C_LatLong_Info} LatLong Info                     & \cellcolor{C_LatLong_Info}            & Coordinate value in Lat/Long Window          \\ \hline
  \nextrow \label{color:C_Overflown} Overflown                           & \cellcolor{C_Overflown}               & Overflown points in Complete Route Window    \\ \hline
  \nextrow \label{color:C_Potential} Potential                           & \cellcolor{C_Potential}               & Potential conflicts in CARD/VAW              \\ \hline
  \nextrow \label{color:C_Select} Select                                 & \cellcolor{C_Select}                  & Selected radio buttons and selection boxes   \\ \hline
  \nextrow \label{color:C_Selected} Selected                             & \cellcolor{C_Selected}                & Active filters in Radar menu                 \\ \hline
  \nextrow \label{color:C_Selected_Group} Selected Group                 & \cellcolor{C_Selected_Group}          & Group of TSA areas in multi edit mode        \\ \hline
  \nextrow \label{color:C_Selected_Period} Selected Period               & \cellcolor{C_Selected_Period}         & Active areas text in area window             \\ \hline
  \nextrow \label{color:C_SMW_Level_Band} SMW Level Band                 & \cellcolor{C_SMW_Level_Band}          & AFL-CFL boxes in SMW                         \\ \hline
  \nextrow \label{color:C_SMW_Overflight} SMW Overflight                 & \cellcolor{C_SMW_Overflight}          & Overflight lines in SMW                      \\ \hline
  \nextrow \label{color:C_SMW_Overlap} SMW Overlap                       & \cellcolor{C_SMW_Overlap}             & Overlapping AFL-CFL boxes in SMW             \\ \hline
  \nextrow \label{color:C_SMW_Overlap_Box} SMW Overlap Box               & \cellcolor{C_SMW_Overlap_Box}         & Multiple same CFL’s box in SMW               \\ \hline
  \nextrow \label{color:C_SMW_Overshoot} SMW Overshoot                   & \cellcolor{C_SMW_Overshoot}           & Level bust AFL-CFL boxes in SMW              \\ \hline
  \nextrow \label{color:C_TopShadow} TopShadow                           & \cellcolor{C_TopShadow}               & 3D effects in windows                        \\ \hline
  \nextrow \label{color:C_Trough} Trough                                 & \cellcolor{C_Trough}                  & Slider area background                       \\ \hline
  \nextrow \label{color:C_TSA_Active} TSA Active                         & \cellcolor{C_TSA_Active}              & Active areas background in area window       \\ \hline
  \nextrow \label{color:C_TSA_Filter} TSA Filter                         & \cellcolor{C_TSA_Filter}              & Active categories in area window             \\ \hline
  \nextrow \label{color:C_TSA_Preactive} TSA Preactive                   & \cellcolor{C_TSA_Preactive}           & Pre-active areas background in area window   \\ \hline
  \nextrow \label{color:C_VAW_Profile} VAW Profile                       & \cellcolor{C_VAW_Profile}             & Selected aircraft profile in VAW             \\ \hline
  \nextrow \label{color:C_VAW_Sector_Limits} VAW Sector Limits           & \cellcolor{C_VAW_Sector_Limits}       & Sector boundaries in VAW                     \\ \hline
  \nextrow \label{color:C_VAW_Track_Position} VAW Track Position         & \cellcolor{C_VAW_Track_Position}      & Selected aircraft position in VAW            \\ \hline
  \nextrow \label{color:C_WM_Active_Fg} WM Active Fg                     & \cellcolor{C_WM_Active_Fg}            & Active window title text                     \\ \hline
  \nextrow \label{color:C_WM_Bg} WM Bg                                   & \cellcolor{C_WM_Bg}                   & Window title bar background                  \\ \hline
  \nextrow \label{color:C_WM_Border} WM Border                           & \cellcolor{C_WM_Border}               & Window border line                           \\ \hline
  \nextrow \label{color:C_WM_Fg} WM Fg                                   & \cellcolor{C_WM_Fg}                   & Window texts                                 \\ \hline
  \nextrow \label{color:C_WM_Frame} WM Frame                             & \cellcolor{C_WM_Frame}                & Window frame when dragging                   \\ \hline
  \nextrow \textit{\textbf{Other colors}}                                &                                       &                                              \\ \hline
  \nextrow \label{color:C_Standard_Line_RDF} Standard Line RDF           & \cellcolor{C_Standard_Line_RDF}       & Direction Finder position circle or direction line \\ \hline
  \nextrow \label{color:C_Text_Notes} Text Notes                         & \cellcolor{C_Text_Notes}              & Text notes                                   \\ \hline                                 
\end{longtable}
