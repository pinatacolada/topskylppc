...
\definecolor{Assumed}{RGB}{220,220,220}
\definecolor{CARD Mark All}{RGB}{255,125,125}
\definecolor{CARD Mark Own}{RGB}{255,124,125}
\definecolor{Concerned}{RGB}{111,153,110}
\definecolor{Coordination}{RGB}{150,215,150}
\definecolor{Freq Indicator}{RGB}{114,136,255}
\definecolor{Info Coord}{RGB}{1,255,255}
\definecolor{Information}{RGB}{40,210,40}
\definecolor{Informed 1}{RGB}{175,125,175}
\definecolor{Informed 2}{RGB}{104,163,195}
\definecolor{Informed 3}{RGB}{147,124,108}
\definecolor{Proposition Accepted}{RGB}{175,125,175}
\definecolor{Proposition In}{RGB}{220,125,175}
\definecolor{Proposition Out}{RGB}{220,125,175}
\definecolor{Redundant}{RGB}{185,140,89}
\definecolor{Rwy Locked}{RGB}{41,210,41}
\definecolor{Sid Star Allocation}{RGB}{15,185,15}
\definecolor{Sid Star No Allocation}{RGB}{14,170,14}
\definecolor{Suite Highlight}{RGB}{0,220,255}
\definecolor{Track Default}{RGB}{210,210,210}
\definecolor{Track Highlight}{RGB}{0,165,219}
\definecolor{Unconcerned}{RGB}{135,128,118}
\definecolor{Unknown}{RGB}{239,224,42}
\definecolor{Urgency}{RGB}{225,25,26}
\definecolor{VFR}{RGB}{110,1,10}
\definecolor{Warning}{RGB}{240,225,41}
\definecolor{CPDLC Controller Late}{RGB}{170,78,39}
\definecolor{CPDLC Discarded}{RGB}{128,128,128}
\definecolor{CPDLC DM Request}{RGB}{30,250,250}
\definecolor{CPDLC Failed}{RGB}{170,78,39}
\definecolor{CPDLC Pilot Late}{RGB}{170,78,40}
\definecolor{CPDLC Standby}{RGB}{170,78,39}
\definecolor{CPDLC UM Clearance}{RGB}{30,251,250}
\definecolor{CPDLC Unable}{RGB}{170,77,39}
\definecolor{CPDLC Urgency}{RGB}{226,25,25}
\definecolor{AIW intrusion}{RGB}{255,152,0}
\definecolor{CARD Min Sep}{RGB}{61,61,61}
\definecolor{Flight Leg}{RGB}{170,231,197}
\definecolor{FPLSEP Tool 1}{RGB}{255,170,46}
\definecolor{FPLSEP Tool 2}{RGB}{204,122,0}
\definecolor{FPLSEP Tool 3}{RGB}{170,102,0}
\definecolor{FPLSEP Tool 4}{RGB}{223,143,1}
\definecolor{FPLSEP Tool 5}{RGB}{255,195,75}
\definecolor{Heading Vector}{RGB}{170,232,197}
\definecolor{Information FL}{RGB}{41,245,41}
\definecolor{Potential FL}{RGB}{40,41,216}
\definecolor{QDM}{RGB}{215,190,163}
\definecolor{SEP Tool 1}{RGB}{153,217,234}
\definecolor{SEP Tool 2}{RGB}{255,153,184}
\definecolor{SEP Tool 3}{RGB}{255,209,143}
\definecolor{SEP Tool 4}{RGB}{197,64,212}
\definecolor{SEP Tool 5}{RGB}{140,140,255}
\definecolor{SEP Tool 6}{RGB}{120,140,255}
\definecolor{SEP Tool 7}{RGB}{90,1,255}
\definecolor{SEP Vert}{RGB}{90,1,100}
\definecolor{System Calculated TOC}{RGB}{170,230,197}
\definecolor{System Calculated TOD}{RGB}{170,231,197}
\definecolor{Urgency FL}{RGB}{225,25,25}
\definecolor{Warning FL}{RGB}{240,226,41}
\definecolor{Active Map}{RGB}{198,174,58}
\definecolor{Active Map Type 1}{RGB}{87,87,164}
\definecolor{Active Map Type 2}{RGB}{80,162,74}
\definecolor{Active Map Type 3}{RGB}{132,142,139}
\definecolor{Active Map Type 4}{RGB}{200,53,18}
\definecolor{Active Map Type 5}{RGB}{198,174,58}
\definecolor{Active Map Type 6}{RGB}{90,90,90}
\definecolor{Active Map Type 7}{RGB}{138,20,12}
\definecolor{Active Map Type 8}{RGB}{195,186,69}
\definecolor{Active Map Type 9}{RGB}{220,125,25}
\definecolor{Active Map Type 10}{RGB}{255,255,255}
\definecolor{Active Map Type 11}{RGB}{51,134,49}
\definecolor{Active Map Type 12}{RGB}{41,102,255}
\definecolor{Active Map Type 13}{RGB}{100,160,100}
\definecolor{Active Map Type 14}{RGB}{141,184,236}
\definecolor{Active Map Type 15}{RGB}{227,213,29}
\definecolor{Active Map Type 16}{RGB}{60,60,60}
\definecolor{Active Map Type 17}{RGB}{155,155,155}
\definecolor{Active Map Type 18}{RGB}{183,26,19}
\definecolor{Active Map Type 19}{RGB}{120,91,65}
\definecolor{Active Map Type 20}{RGB}{138,69,58}
\definecolor{Active RD Infill Map}{RGB}{90,90,90}
\definecolor{Active RD Map}{RGB}{150,41,43}
\definecolor{Active Text Map}{RGB}{190,190,190}
\definecolor{Auto Map Label}{RGB}{159,159,160}
\definecolor{Auto Map Symbol}{RGB}{110,130,140}
\definecolor{East NAT Map}{RGB}{180,180,1}
\definecolor{Map 1}{RGB}{80,95,95}
\definecolor{Map 2}{RGB}{44,44,44}
\definecolor{Map 3}{RGB}{100,108,111}
\definecolor{Map 4}{RGB}{52,58,62}
\definecolor{Map Hotspot}{RGB}{87,139,200}
\definecolor{Map Border}{RGB}{134,134,135}
\definecolor{Map Info}{RGB}{150,150,150}
\definecolor{Map Land}{RGB}{140,140,0}
\definecolor{Map Symbol}{RGB}{110,130,140}
\definecolor{Preactive Map}{RGB}{154,138,128}
\definecolor{Preactive Text Map}{RGB}{155,147,138}
\definecolor{Predisplay Map}{RGB}{175,130,130}
\definecolor{Rwy App Line Inuse}{RGB}{82,190,115}
\definecolor{Rwy App Line Not Inuse}{RGB}{135,135,70}
\definecolor{TSA Border Highlight}{RGB}{255,254,255}
\definecolor{Weather Map}{RGB}{0,0,86}
\definecolor{West NAT Map}{RGB}{40,140,255}
\definecolor{Arm}{RGB}{97,97,97}
\definecolor{Map Bright}{RGB}{52,58,62}
\definecolor{Background}{RGB}{74,80,85}
\definecolor{Border}{RGB}{51,51,52}
\definecolor{BottomShadow}{RGB}{70,70,70}
\definecolor{CARD Conflict Number}{RGB}{9,10,11}
\definecolor{CARD Time Vector}{RGB}{171,231,197}
\definecolor{Field Highlight}{RGB}{72,72,73}
\definecolor{Flight Highlight}{RGB}{36,41,45}
\definecolor{Foreground}{RGB}{200,200,200}
\definecolor{Global Menu Highlight}{RGB}{1,165,219}
\definecolor{Inactive Sector}{RGB}{74,80,85}
\definecolor{LatLong Info}{RGB}{169,231,197}
\definecolor{Overflown}{RGB}{82,105,146}
\definecolor{Potential}{RGB}{41,40,216}
\definecolor{Select}{RGB}{151,215,150}
\definecolor{Selected}{RGB}{61,121,148}
\definecolor{Selected Group}{RGB}{226,210,210}
\definecolor{Selected Period}{RGB}{255,255,41}
\definecolor{SMW Level Band}{RGB}{24,209,114}
\definecolor{SMW Overflight}{RGB}{254,152,1}
\definecolor{SMW Overlap}{RGB}{224,25,25}
\definecolor{SMW Overlap Box}{RGB}{207,207,207}
\definecolor{SMW Overshoot}{RGB}{239,224,40}
\definecolor{TopShadow}{RGB}{155,158,159}
\definecolor{Trough}{RGB}{97,99,97}
\definecolor{TSA Active}{RGB}{93,138,195}
\definecolor{TSA Filter}{RGB}{255,253,255}
\definecolor{TSA Preactive}{RGB}{132,142,139}
\definecolor{VAW Profile}{RGB}{152,202,172}
\definecolor{VAW Sector Limits}{RGB}{145,95,30}
\definecolor{VAW Track Position}{RGB}{219,219,219}
\definecolor{WM Active Fg}{RGB}{255,254,254}
\definecolor{WM Bg}{RGB}{100,100,105}
\definecolor{WM Border}{RGB}{88,95,99}
\definecolor{WM Fg}{RGB}{180,184,181}
\definecolor{WM Frame}{RGB}{88,95,99}
\definecolor{Standard Line RDF}{RGB}{11,12,19}
\definecolor{Text Notes}{RGB}{125,125,125}
...
The plugin does not allow the following downlink message types. They will be automatically closed and a reply sent informing that the system does not support the message type:
...
Note that a non-allowed message type can be classified as “free text” by the plugin if the message parser doesn’t recognize it as a non-allowed type. In this case the automatic reply will not be sent and the message may be left waiting for an answer if an answer is required.
...
As with DCL messages, the most likely failure scenario is the plugin misinterpreting the contents of a received message, which can be verified on the \textit{\titleref{win:dlcmw}}. Some other failure scenarios are presented below.

If the plugin has temporarily lost contact with the CPDLC server, “CPDLC COMM FAIL” will be inserted in line 0 of the labels of all CPDLC connected aircraft in \colorref{color:CPDLC Failed} color:
