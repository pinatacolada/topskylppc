...
\begin{Warn}
  IF THERE IS NO ACTIVE "CDM MASTER" THE PLUGIN WILL NOT BE OPERATIONAL
\end{Warn}
...
\begin{longtable}{|p{2.5cm}|p{2.5cm}|p{4.5cm}|p{4.5cm}|}
  ...
  TSAC \nextrow \label{tag:cdm:TSAC}&  
    Target Start-Up Approval Communicated Time&
      Used to note down Start-Up Approval Time &   
       If inside TSAT window:

       \colorref{color:color1}

       If outside TSAT window:
