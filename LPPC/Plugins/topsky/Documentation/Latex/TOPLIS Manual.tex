...
\begin{longtable}{p{5cm} p{7.5cm}}
  ...
  Concerned                   & Toggles the display of \stateref{Concerned} aircraft           \\
...
\begin{Warn}
  The sequence number will not be transmitted to other controllers except the next controller (during transfer) unless the flight strip is manually sent.
\end{Warn}
