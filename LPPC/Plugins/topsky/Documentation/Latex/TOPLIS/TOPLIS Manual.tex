...
\begin{longtable}{|p{2.5cm}|p{2.5cm}|p{4.5cm}|p{4.5cm}|}
  ...
  * \nextrow \label{tag:*}&
  ...
  HOLD &
    ...
    If “XHOLD”: \colorref{Warning} \\ \hline
...
The “APP Clr” folder contains other available approach types to populate the \winref{tag:ACF} field:
...
\begin{longtable}{p{2.5cm} p{10cm}}
    ...
    FAST                & Displayed if FAST function is enabled \\
\end{longtable}
