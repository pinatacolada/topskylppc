...
\begin{longtable}{|p{2.5cm}|p{2.5cm}|p{4.5cm}|p{4.5cm}|}
  ...
  * \nextrow \label{tag:*}&
  ...
  FSQ \nextrow \label{tag:FSQ} &
    ...
    If sequence warning or missed approach: \colorref{Warning} \\ \hline
...
\begin{longtable}{p{5cm} p{7.5cm}}
  ...
  FAST                    & Sets the status of the FAST function\\        
\end{longtable}
\medskip
...
\note{FAST functionality is not implemented}
...
\begin{longtable}{|p{3cm}|p{2cm}|p{6cm}|}
  ...
  Gap indicator         & [  &  Selected track: \colorref{Track Highlight} 
...
\begin{itemize}
  ...
  \item the separation indicator is further away from the gap indicator than a pre-defined distance.
\end{itemize}

The gap indicator is hidden if:

\begin{itemize}
  \item the aircraft overtakes its gap indicator, or;
  \item the gap is smaller than the required minimum separation.
\end{itemize}
...
The GAP menu is used to set an approach gap or cancel an existing one, either only behind the specified aircraft (manual gap), or also behind all the following ones (systematic gap).
...
\begin{enumerate}
  \item Unselect the “Systematic” checkbox;
...
To set a systematic gap starting from the selected aircraft:

\begin{enumerate}
  \item Select the “Systematic” checkbox;
  \item Select a value from the list, or enter a custom value to the edit field at the bottom (values from 0.1 to 40.0 nm are accepted)
\end{enumerate}

To cancel an existing manual gap:
...
To cancel a systematic gap starting from the selected aircraft:
...
\begin{longtable}{|p{0.10\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|} \hline
  \textbf{Item} & \textbf{Type} & \textbf{Left Mouse}     & \textbf{Right Mouse} \endhead \hline
    ...
    ARWY        & optional      & Open runway popup list  &                           \\ \hline
