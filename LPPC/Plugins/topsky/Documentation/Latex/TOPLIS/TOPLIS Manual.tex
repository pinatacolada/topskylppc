...
\begin{longtable}[c]{|l|p{8cm}|p{2cm}|}
  ...
  \colortab{Warning}MSAW           & Minimum Safe Altitude Warning                                                                                               & \tagref{tag:MSAW}          \\ \hline
  \colortab{Warning}APM            & Area Proximity Warning                                                                                                      & \tagref{tag:APM}           \\ \hline
  ...
  \colortab{Assumed}L              & Cleared Level Adherence Monitoring, same color as Track Label                                                               & \tagref{tag:CLAM}          \\ \hline
  \colortab{Warning}DUPE           & Duplicate SSR code                                                                                                          & \tagref{tag:DUPE}          \\ \hline
  \colortab{Urgency}O              & RVSM Not Equipped                                                                                                           & \tagref{tag:O}             \\ \hline
  ...
  \colortab{Warning}F              & Mode S Callsign is different from coupled Flight Plan Callsign                                                              & \tagref{tag:S}             \\ \hline
  ...
  \colortab{Assumed}A1000          & Displays ASSR if different from TSSR, same color as Track Label                                                             & \tagref{tag:NSSR}          \\ \hline
