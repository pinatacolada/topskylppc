...
\begin{tikzpicture}
  ...
  \drawtagdesc{3cm}{0,4}{lcallsign}{L: Open \winref{menu:cs} \\ R: Open \winref{label:ext} \\ Shift+R: Toggle \winref{label:min}};
...
\begin{tikzpicture}
  ...
  \drawtagdesc{3.8cm}{1.6,-1}{ldsfl}{L: Toggle associated mode S downlink parameter display};
