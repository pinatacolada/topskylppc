...
\begin{longtable}{|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|} \hline
  ...
  FSTS                          &                                     & Network Status Options    \\ \hline
  TSAT                          & Set TOBT to Now                     &                           \\ \hline
  TTOT                          & Edit TTOT                           &                           \\ \hline
  CTOT                          &                                     &                           \\ \hline
...
TSAT, TTOT and CTOT fields are Runway Manager related. Refer to Runway Manager documentation for details.
...
The Departure Coordination Window can be used to set the clearance flag. The window displays the aircraft callsign, departure runway, destination and beginning of the route and allows setting the \tagref{tag:CFL}, \tagref{tag:ASSR} and EOBT values.
