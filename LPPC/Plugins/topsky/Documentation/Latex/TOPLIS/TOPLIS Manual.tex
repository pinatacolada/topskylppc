...
\begin{tabular}{l l}
  ...
  No conflict, but conflict level(s) between it and AFL     & \colorref{BS Crossed Level} \\
  No conflict, and no conflict level(s) between it and AFL  & \colorref{BS No Conflict}   \\
